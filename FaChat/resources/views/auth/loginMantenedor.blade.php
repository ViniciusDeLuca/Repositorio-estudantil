            ...
            <div class="card-header" id="header-color-al">
                <div class="content-form-login">
                    <div class="login-wrapper">
                        ...
                        <form class="login-form" method="get" action="{{ route('logarMantenedor') }}"
                            autocomplete="off" id="cidadao-form">
                            <div class="form-group border">
                                <label for="login" class="sr-only">Login</label>
                                <img src="/image/auth/doc.png" alt="login" id="icon-login">
                                <input value="{{ old('login') }}" required name="login" type="login"
                                    placeholder="Login" class="form-control" id="login" aria-describedby="login">
                            </div>
                            <div class="form-group border">
